...
- 原始页面：[Notion 课程大纲](https://distinct-capricorn-c04.notion.site/Syllabus-High-Performance-Computing-for-AI-1f788315b6b48050946ede67ec5c086f)
- 整理日期：2026-08-17
- 英文整理版：[English source version](source/info-7375-syllabus.en.md)

> 本文是原始课程大纲的中文整理快照。评分、迟交和作业提交规则只用于记录当时的
> 课程组织方式，不代表本仓库当前要求，也不应视为东北大学的最新课程政策。
...
- 可选：[Jason Sanders 与 Edward Kandrot，*CUDA by Example*](https://edoras.sdsu.edu/~mthomas/docs/cuda/cuda_by_example.book.pdf#page=43.00)。

## 教学方式

- 通过每周项目从零构建系统，在实现中学习；
- 课堂以 live coding 为主，集中处理每周项目中的困难概念；
- 阅读并实现高性能计算领域的近期研究工作，例如：
